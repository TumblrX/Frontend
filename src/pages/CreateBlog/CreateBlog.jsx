...
import {setIsRobot, setBlogHandle, setBlogTitle, setBlogPrivacy, setBlogPassword} from "../../redux/createBlog"
...
function CreateBlog() {
    ...
    const {blogHandle, blogTitle, blogIsPrivate, blogPassword, isRobot}=useSelector((state)=>state.create)
   ...
   */
     ...
     /**
   * this function handle the event of changing checkbox of making the blog private to keep it in sync with the state
        ...
        <div className={styles.baseContanier}>
            <div className={styles.contanier}>
                <div className={styles.clear}>
                    <h1>Create a new {blogIsPrivate? "Private":""} blog</h1>
                    ...
                    <p>
                        <strong>Note</strong>
                        : If you want to Like posts or Follow other users with this blog identity, you must log out and create a separate account.
                        </p>
                    <p>
                        Learn more about <a href="https://tumblr.zendesk.com/hc/en-us/sections/205853348-Blog-management">Primary vs. Secondary blog features here</a>.
                        </p>
                    </div>
                    <div 
                        id="errors" 
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className={styles.secondSection}>
                            ...
                            <button 
                            type="submit" className={`${styles.chrome} ${styles.big} ${styles.blue}`} 
                            id="submit_button"
                            >
                                <span id="submit_button_text">
                                    Create {blogIsPrivate? "Private":""} blog
                                </span>
                            </button>
                        </div> 
                    </form> 
